...
std::optional<std::vector<std::shared_ptr<MeshAsset>>> load_gltf_meshes(VulkanEngine* engine, std::filesystem::path filePath)
{
    ...
    for (fastgltf::Mesh& mesh : gltf.meshes) {
        ...
        for (auto&& p : mesh.primitives) {
            ...
            newSurface.index_count = static_cast<uint32_t>(gltf.accessors[p.indicesAccessor.value()].count);

            size_t initial_vtx = vertices.size();
            fmt::print("Loaded mesh: {} \n", mesh.name);
            ...
            fmt::print("load indexes Loaded mesh: {} \n", mesh.name);
            ...
            fmt::print("POSITION Loaded mesh: {} \n", mesh.name);
            ...
            fmt::print("TEXCOORD_0 Loaded mesh: {} \n", mesh.name);
